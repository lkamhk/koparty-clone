              ...
              <Link href={'/single'}>
                <div className='w-[100%] h-[100%] relative'>
                  ...
                  <div className=' w-100 flex flex-row text-center items-center'>
                    <h4 className=' absolute bg-white bottom-[38%] right-[80px]  w-[auto] h-[22px] text-[19px] font-[550] xs:left-[10px]'>
                    &nbsp; 男：HKD380  女：HKD280 &nbsp;
                    </h4>
                  </div>
            ...
            <div className='block mx-[15px] h-[580px] shadow-md row-span-1 col-span-1'>
              <Link href={'/single'}>
                <div className='w-[100%] h-[100%] relative'>
                  ...
                  <div className=' w-100 flex flex-row text-center items-center'>
                    <h4 className=' absolute bottom-[38%] right-[200px]  w-[auto] h-[22px] text-[19px] font-[550] xs:right-[10px]'>
                      男：HKD380  女：HKD280
                    </h4>
                  </div>
